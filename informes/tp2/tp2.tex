...
complementarias. En $\rho=2$ aparecen fragmentaciones breves, pero el
cluster más grande sigue conteniendo a la mayor parte del sistema; para
$\rho=4$ y $8$ se mantiene en uno durante toda la corrida. En $\rho=1/\pi$ el
comportamiento cambia: sin ruido el sistema se reúne en un único cluster a
partir de $t\simeq400$ s, con $\eta=0{,}5$ rad $S$ fluctúa entre $0{,}5$ y
$1$ sin estabilizarse, y con $\eta=2$ rad oscila alrededor de $0{,}4$.
...
\begin{figure}[H]
    ...
    \end{minipage}\hfill
    \begin{minipage}{\figwpair}
        \centering\includegraphics[width=\linewidth]{evolucion_s_vicsek_rho0.3183.png}\\
        (b) $\rho=1/\pi$, $T=5000$ s.
    \end{minipage}
    ...
    estacionario de la curva de su color; las curvas sin marca no se
    estabilizan alrededor de un valor fijo dentro de la corrida. En (a) el eje
...
corrida sin ruido alcanza el estado estacionario $\va=1$ en $t\simeq320$ s.
Para $\eta=0{,}5$ rad, una realización individual mantiene fluctuaciones
amplias y no se estabiliza alrededor de un valor fijo; para $\eta=2$ rad la
polarización permanece baja desde el inicio. Sin embargo, para $\eta=0{,}5$
rad la media entre las 50 realizaciones fue $0{,}282$ en el tercer cuarto de
la corrida y $0{,}288$ en el último: el ensamble es estacionario aunque cada
realización fluctúe, lo que respalda el promedio sobre $t\geq T/2$, y el
desvío entre realizaciones conserva esa dispersión. Los promedios
estacionarios de las tres curvas son $\langle\overline{\va}\rangle=1{,}000$;
...
\begin{figure}[H]
    ...
    $\eta=0{,}5$ rad no se marca porque esa realización no se estabiliza
    alrededor de un valor fijo, aunque el ensamble sí es estacionario.}
...
cluster más grande abarca prácticamente todo el sistema. En $\rho=1/\pi$, sin
ruido el sistema queda en un único cluster a partir de $t\simeq900$ s; con
$\eta=0{,}5$ rad $S$ fluctúa entre $0{,}3$ y $0{,}9$ sin estabilizarse, y
con $\eta=2$ rad oscila alrededor de $0{,}2$, por debajo de Vicsek.
...
\begin{figure}[H]
    ...
    \end{minipage}\hfill
    \begin{minipage}{\figwpair}
        \centering\includegraphics[width=\linewidth]{evolucion_s_voter_rho0.3183.png}\\
        (b) $\rho=1/\pi$, $T=5000$ s.
    \end{minipage}
    ...
    $2$ rad. Cada línea vertical de trazos marca el comienzo del régimen
    estacionario de la curva de su color; las curvas sin marca no se
    estabilizan alrededor de un valor fijo dentro de la corrida. En (a) el eje
    vertical se acotó al intervalo donde varían los datos.}
