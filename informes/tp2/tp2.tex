...
\begin{table}[!htb]
    ...
    \begin{tabular}{ll}
        ...
        Densidades principales, $\rho$ & $2$; $4$; $8$ ($N=200$; $400$; $800$) \\
        Densidades complementarias, $\rho$ & $1/(3\pi)$; $1/(2\pi)$; $1/\pi$ ($N=11$; $16$; $32$) \\
        Ruido, $\eta$ (rad) & $0$; $0{,}25$; $0{,}5$; $0{,}75$; $1$; $1{,}5$; \\
        & $2$; $2{,}5$; $3$; $3{,}5$; $4$; $4{,}5$; $5$; $5{,}5$; $6{,}28$ \\
        Realizaciones por punto & $50$ \\
        Duración, $T$ & $2000$ s ($5000$ s para $\rho<2$; $10000$ s para votante con $\eta=0$) \\
        \bottomrule
    \end{tabular}
...
\end{equation}
Aquí $\vect{v}_i(t)$ es la velocidad de la partícula $i$ y $v=|\vect{v}_i(t)|$,
...
sobre la segunda mitad de la corrida, para asegurar que el sistema ya alcanzó
el estado estacionario (Sección~\ref{sec:resultados}):
\begin{equation}
...
el desvío estándar entre realizaciones; las rectas que unen puntos
consecutivos son solo guía para el ojo.
...
OpenJDK 21) y en la misma sesión. La Fig.~\ref{fig:cim} reúne las tres
series.

Los dos modelos del TP2 dan tiempos del mismo orden y con la misma pendiente,
como corresponde a una rutina de vecindad idéntica en ambos: en $N=200$,
$0{,}07\pm0{,}01$ ms para Vicsek y $0{,}062\pm0{,}002$ ms para el votante,
contra $0{,}058\pm0{,}009$ ms del TP1. Al multiplicar $N$ por cuatro, el
tiempo por llamada crece un factor $9{,}8$ en Vicsek, $10{,}2$ en el votante
y $11$ en el TP1. El crecimiento supera al de $N$ porque $L$ y $M$ se
mantienen fijos: al aumentar $N$ crece la ocupación de cada celda, y con ella
la cantidad de pares que el método revisa por partícula.
