...
\begin{frame}{Tiempos del CIM}
  \begin{itemize}
    \item En cada paso se cronometra solo \texttt{cim.findNeighbors} (\texttt{System.nanoTime}).
    \item $N = 200,\,400,\,800$ ($L = 10\uni{m}$, $\rho = 2,\,4,\,8$), partículas puntuales, PBC.
    \item Comparación con el TP1 a los mismos $N$: pendiente (los tiempos están en cada \texttt{run.json}).
  \end{itemize}
\end{frame}
